<template>
  <div class="freezerdetails" ref="rootRefs">
    ...
    <div class="content">
      <div class="title">
        {{reportList.scene_report_number}}-{{sceneList.name}} 
      </div>
     <!--  <div class="address">
      ...
      <div class="time">
        报告时间：{{reportList.created_at|dataFormYMD}}
      </div>
      <div class="time">
        业代编号：{{storeList.group_number}}{{storeList.line_number}}
      </div>
      <div class="time">
        售点：{{storeList.store_number}}-{{storeList.storename}}
      </div>
    </div>
    ...
    <div class="Skunum">
      <div class="title">
        SKU数量<span style="font-size:18px;">({{reportList.sku_total_num}})</span>
      </div>
    </div>
    <div class="tree">
